...
- [DataImages](../DataImages/README.md)
...
|`queue-image-version`| `php7.0-v1.0` | Which docker image version do you need: (default: `php7.0-v1.0`; also `php7.1-v2.0`, `php7.2-v3.0`, `php7.3-v4.0` and `latest` are [valid](https://hub.docker.com/r/ipunktbs/laravel-queue-worker/tags/) right now) |
